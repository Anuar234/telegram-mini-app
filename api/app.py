        ...
        createApp({
            data() {
                return {
                    ...
                    nutrition: [
                        {id: 1, title: "День 1 - Понедельник", description: "Сбалансированное начало недели", image_url: "/nutrition/day1.jpg", day: 1},
                        {id: 2, title: "День 2 - Вторник", description: "Белковый день", image_url: "/nutrition/day2.jpg", day: 2},
                        {id: 3, title: "День 3 - Среда", description: "Овощной рацион", image_url: "/nutrition/day3.jpg", day: 3},
                        {id: 4, title: "День 4 - Четверг", description: "Энергетический день", image_url: "/nutrition/day4.jpg", day: 4},
                        {id: 5, title: "День 5 - Пятница", description: "Рыбный день", image_url: "/nutrition/day5.jpg", day: 5},
                        {id: 6, title: "День 6 - Суббота", description: "Легкий рацион", image_url: "/nutrition/day6.jpg", day: 6},
                        {id: 7, title: "День 7 - Воскресенье", description: "Восстановительный день", image_url: "/nutrition/day7.jpg", day: 7}
                    ],
                    activeVideos: {}
                }
            },
            ...
            template: `
                <div class="container">
                    ...
                    <div v-if="currentView === 'training'">
                        ...
                        <img src="/photo-training_equipment.webp" alt="Тренажер" 
