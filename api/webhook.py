...
class handler(BaseHTTPRequestHandler):
    ...
    async def handle_start(self, bot, chat_id, InlineKeyboardButton, InlineKeyboardMarkup):
        ...
        try:
            ...
            gif_url = "https://raw.githubusercontent.com/Anuar234/telegram-mini-app/main/public/welcome.gif"
            try:
                ...
                logger.warning(f"Failed to send animation, fallback to text: {e}")
